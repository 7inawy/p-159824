      ...
      <div className="self-stretch min-w-60 text-black w-[575px] my-auto rounded-[0px_0px_0px_0px] max-md:max-w-full">
        <div className="flex flex-col relative min-h-[460px] w-full pr-20 pt-[146px] pb-[74px] rounded-[0px_0px_0px_0px] max-md:max-w-full max-md:pr-5 max-md:pt-[100px]">
          ...
          <div className="flex flex-col relative aspect-[1.321] w-[280px] max-w-full text-base font-normal pl-[21px] pr-14 pt-[9px] pb-[65px] max-md:px-5">
            <img
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/630fbe2b42db2ac693212b56cb71c82f5830ea64?placeholderIfAbsent=true"
              alt="Background"
              className="absolute h-full w-full object-cover inset-0"
            />
            ...
            <img
              src={rating}
              alt="Rating"
              className="aspect-[6.02] object-contain w-[145px] max-w-full mt-[95px] max-md:mt-10"
            />
          </div>
        </div>
      </div>
...
const Testimonials: React.FC = () => {
  const testimonialContent =
    "لأننا مؤمنين إن مجتمعنا الطبي مليان مواهب، لم تُكتشف بعد.. قررنا إن أكاديميتنا تكسر الصندوق المجتمعي اللي اتحطينا فيه من زمان، وبمساعدة المتخصصين في مجالات الإرشاد المهني صممنا برامج معتمدة على الخلفية الطبية والمهارات والمواهب، هتأهلك تشتغل في مجالات موازية وكمان تدخلك دخل إضافي";

  return (
    <section
      id="testimonials"
      className="flex min-h-[690px] flex-col overflow-hidden items-center justify-center mt-[15px] py-px max-md:max-w-full max-md:mr-[3px]"
    >
        ...
        <div className="flex w-full items-center gap-[40px_55px] flex-wrap mt-[70px] max-md:max-w-full max-md:mt-10">
          ...
          <div className="self-stretch flex min-w-60 items-center gap-[40px_50px] flex-wrap my-auto max-md:max-w-full">
            ...
            <div className="self-stretch flex min-w-60 flex-col w-[575px] my-auto rounded-[0px_0px_0px_0px] max-md:max-w-full">
              <img
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/9fce85c7-44ce-4acf-a89f-d792b62b015a?placeholderIfAbsent=true"
                alt="Testimonial"
                className="aspect-[0.87] object-contain w-[400px] max-w-full"
              />
            </div>
          </div>
        </div>
